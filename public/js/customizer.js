...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "./images/css/"+color+".css" );
